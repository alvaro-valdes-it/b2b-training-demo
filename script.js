const translations = {
    en: {
        ...
        faqA4: "Please notify us at least 24 hours in advance to cancel or reschedule a session.",
        faqQ5: "What payment methods do you accept?",
        faqA5: "We accept Zelle, cash, and card payments.",
        faqQ6: "Do I need previous training experience?",
        faqA6: "No. Programs are tailored to your current fitness level, whether you're just starting out or training for years.",
        faqQ7: "Can I switch between plans?",
    ...
    es: {
        ...
        bookGroup: "Reservar Grupo Pequeño",
        ...
        faqA4: "Notifícanos con al menos 24 horas de anticipación para cancelar o reprogramar una sesión.",
        faqQ5: "¿Qué métodos de pago aceptan?",
        faqA5: "Aceptamos Zelle, efectivo y tarjeta.",
        faqQ6: "¿Necesito experiencia previa entrenando?",
        faqA6: "No. Los programas se adaptan a tu nivel actual, ya sea que estés comenzando o llevando años entrenando.",
        faqQ7: "¿Puedo cambiar entre planes?",
...
const languageLinks = document.querySelectorAll("[data-href-es][data-href-en]");
...
function setLanguage(language) {
    ...
    languageLinks.forEach((link) => {
        const newHref = link.getAttribute(`data-href-${language}`);
